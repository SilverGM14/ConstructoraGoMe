...
import ProtectedRoute from '@/lib/ProtectedRoute'   // ← Importación necesaria
import { motion } from 'framer-motion'              // ← Si quieres animación, aunque no es obligatoria
  ...
  return (
    <ProtectedRoute>
      <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
        {/* Aquí va todo el contenido de la factura que ya te di */}
